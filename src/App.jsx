...
const App = () => {
  const [activeView, setActiveView] = useState("calendar"); // 'album' or 'calendar'
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <header className="flex flex-col md:flex-row md:items-center md:justify-between px-4 py-4 border-b border-gray-800 bg-gray-900 sticky top-0 z-50">
        {/* Title */}
        <h1 className="text-3xl font-bold text-indigo-400 mb-3 md:mb-0">Skdool</h1>
      ...
      {/* Content */}
      <main>
        {activeView === "album" ? <AlbumView /> : <CalendarView />}
      </main>
    </div>
  );
};
